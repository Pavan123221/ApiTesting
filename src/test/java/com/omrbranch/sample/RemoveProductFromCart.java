...
import com.omrbranch.pojo.removeitem.RemoveItemFromCart_Output_Pojo;
...
public class RemoveProductFromCart extends BaseClass {
	...
	public void removeProductFromCarts() {
		...
		AddProduct_Input_Pojo addProduct_Input_Pojo = new AddProduct_Input_Pojo(textProductid, variantId, "minus");
		...
		System.out.println(statusCode);
		   ...
		   RemoveItemFromCart_Output_Pojo removeItemFromCart_Output_Pojo = response.as(RemoveItemFromCart_Output_Pojo.class);
		   String message = removeItemFromCart_Output_Pojo.getMessage();
		   System.out.println(message);
	}

	public static void main(String[] args) {
		RemoveProductFromCart removeProductFromCart=new RemoveProductFromCart();
		removeProductFromCart.login();
		removeProductFromCart.addFavouritesDetails();
		removeProductFromCart.productList();
		removeProductFromCart.removeProductFromCarts();
