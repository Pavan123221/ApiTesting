...
import com.omrbranch.pojo.favourites.Variation;
...
public class RemoveFavourites  extends BaseClass{
		...
		public void removeFavouriteDetails() {
			initRestAssured();
		...
		public void productList() {
			...
			for (ChildProductList childProductList : data) {
				...
				if (name.equals("Nuts & Seeds - Raw Peanut")) {
					...
					ArrayList<com.omrbranch.pojo.productlist.Variation> variations = childProductList.getVariations();
					for (com.omrbranch.pojo.productlist.Variation eachVariations : variations) {
		...
		public void managFavourites() {
			...
			ManageUserFavourites_Output_Pojo manageUserAddress_Output_Pojo = response.as(ManageUserFavourites_Output_Pojo.class);
		...
		public static void main(String[] args) {
			RemoveFavourites remove = new RemoveFavourites();
			remove.login();
			remove.removeFavouriteDetails();
			remove.productList();
			remove.managFavourites();
